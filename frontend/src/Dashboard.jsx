...
const PatientHomeView = ({ user, results, messages, newResultsCount, unreadCount, loadResults, handleLogout, formatDate, setView, setResultSearch, setShowChangePasswordModal }) => {
...
const AdminHomeView = ({ results, handleLogout, setShowAddPatientModal, loadAllUsers, setShowUsersModal, loadGroups, setShowGroupsModal, setShowStatsModal, setShowConfigModal, setView, setShowChangePasswordModal }) => (
  <div className="space-y-6">
    ...
    <div className="min-h-screen bg-[#F4F7F6]" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-2xl mx-auto p-4 pb-24">
        {view === 'home' && (
          user?.role === 'patient' ? (
            ...
            <AdminHomeView results={results} handleLogout={handleLogout} setShowAddPatientModal={setShowAddPatientModal} loadAllUsers={loadAllUsers} setShowUsersModal={setShowUsersModal} loadGroups={loadGroups} setShowGroupsModal={setShowGroupsModal} setShowStatsModal={setShowStatsModal} setShowConfigModal={setShowConfigModal} setView={setView} setShowChangePasswordModal={setShowChangePasswordModal} />
          )
        )}
        {view === 'results' && (
          <ResultsView
      ...
      {showChangePasswordModal && (
        ...
        >
          ...
          >
            <ModalHeader icon={Lock} title="Changer mon mot de passe" onClose={() => setShowChangePasswordModal(false)} />
